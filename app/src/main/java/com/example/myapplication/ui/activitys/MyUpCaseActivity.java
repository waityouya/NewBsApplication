...
public class MyUpCaseActivity extends AppCompatActivity implements GlobalHandler.HandleMsgListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_up_case);
        initView();
    ...
    private void checkInvalidDialog() {
        final NormalDialog dialog = new NormalDialog(MyUpCaseActivity.this);
        ...
        dialog.setOnBtnClickL(new OnBtnClickL() {
            ...
            public void onBtnClick() {
                ...
                editor.apply();
                Intent intent = new Intent(MyUpCaseActivity.this, MainActivity.class);
