...
Java_com_example_myapplication_util_PlateRecognition_InitPlateRecognizer(
...
Java_com_example_myapplication_util_PlateRecognition_SimpleRecognization(
        JNIEnv *env, jobject obj,
...
Java_com_example_myapplication_util__PlateRecognition_ReleasePlateRecognizer(JNIEnv *env, jobject obj,
                                                                  jlong object_re) {
